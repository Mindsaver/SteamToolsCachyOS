...
# Requires: curl, python3. Optional: fuse2 / libfuse2 so the AppImage can run (see note at end).
...
echo ""
echo "If you see \"libfuse.so.2\" / FUSE errors when launching, install FUSE 2, e.g.:"
