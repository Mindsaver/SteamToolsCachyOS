...
a = Analysis(
    ...
    hiddenimports=['dll_ffx_versions', 'vdf', 'steam_launch_options_core', 'launch_options_window', 'launch_options_compose', 'launch_options_structured_panel', 'gpu_vendor_detect', 'fsr_dll_window'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
